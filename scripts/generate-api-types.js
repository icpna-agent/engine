...
const OUTPUT_DIR = path_1.default.resolve(__dirname, '../../erixcel-admin/src/api');
...
`;
function cleanMethodNames(content) {
    ...
    return content.replace(blockRegex, (match, indent, tag, body) => {
        ...
        const cleanBody = body.replace(methodRegex, (mMatch, mIndent, suffix, mRest) => {
...
async function generate() {
    ...
    try {
        ...
        const outputPath = path_1.default.resolve(OUTPUT_DIR, OUTPUT_FILE);
        if (fs_1.default.existsSync(outputPath)) {
            let content = fs_1.default.readFileSync(outputPath, 'utf8');
